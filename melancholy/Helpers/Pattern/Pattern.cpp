...
DWORD CPattern::FindInClient(PCCH szPattern)
{
...
DWORD CPattern::FindInEngine(PCCH szPattern)
{
...
DWORD CPattern::FindInModule(PCCH szModuleName, PCCH szPattern)
{
	static HMODULE hmModule = GetModuleHandleSafe(szModuleName);
	static PIMAGE_DOS_HEADER pDOSHeader = (PIMAGE_DOS_HEADER)hmModule;
	static PIMAGE_NT_HEADERS pNTHeaders = (PIMAGE_NT_HEADERS)(((DWORD)hmModule) + pDOSHeader->e_lfanew);
